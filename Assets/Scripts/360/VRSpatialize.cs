...
public class VRSpatialize : MonoBehaviour
{
...
void Start()
{
    VRUnity_AssignRaycastCallback(AudioRaycast, System.IntPtr.Zero);
}

void OnDestroy()
{
    VRUnity_AssignRaycastCallback(System.IntPtr.Zero, System.IntPtr.Zero);
}
...
void Update()
{
    ...
    if (visualizeRoom)
    {
        ...
        Vector3 pos;
        VRUnity_GetRoomDimensions(dims, coefs, out pos);
        ...
        VRUnity_GetRaycastHits(points, normals, HIT_COUNT);
